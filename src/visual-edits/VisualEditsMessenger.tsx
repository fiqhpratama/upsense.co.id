...
export default function HoverReceiver() {
  ...
  // Restore visual edit mode from localStorage after mount
  useEffect(() => {
  ...
  useEffect(() => {
    if (isVisualEditMode && !styleElementRef.current) {
      ...
      style.textContent = `
        ...
        /* Prevent the default green highlight on contenteditable */
  ...
  return (
    <>
      {/* Hover box - shows on hover with green overlay */}
        ...
        <>
          ...
          {hoverBoxes
            ...
            .map((box, index) => (
              <div key={index}>
                <div
                  className="fixed pointer-events-none border-[0.5px] border-[#013324] bg-primary/20 border-dashed rounded-sm"
                  style={{
                    zIndex: 100000,
                    left: box.left,
                    top: box.top,
                ...
                {hoverTag && (
                  <div
                    className="fixed pointer-events-none text-[10px] text-white bg-[#013324] px-1 py-0.5 rounded-sm"
                    style={{
                      zIndex: 100001,
                      left: box.left,
                      top: box.top - 20,
      ...
      {isVisualEditMode && focusBox && (
        <>
          {focusTag && (
            <div
              className="fixed text-[10px] font-semibold text-white bg-[#013324] px-1 rounded-sm pointer-events-none select-none"
              style={{
                zIndex: 100003,
          ...
          <div
            className="fixed pointer-events-none border-[1.5px] border-[#013324] rounded-sm"
            style={{
              zIndex: 100001,
              left: focusBox.left,
              top: focusBox.top,
          ...
          {!isResizing && (
            <>
              {/* Corner handles */}
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-nw-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left - 4,
                  top: focusBox.top - 4,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-ne-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-sw-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left - 4,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-se-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left + focusBox.width - 4,
                  top: focusBox.top + focusBox.height - 4,
              ...
              {/* Edge handles */}
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-n-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-s-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left + focusBox.width / 2 - 4,
                  top: focusBox.top + focusBox.height - 4,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-w-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left - 4,
              ...
              />
              <div
                className="fixed w-2 h-2 bg-[#013324] rounded-full cursor-e-resize pointer-events-auto resize-handle"
                style={{
                  zIndex: 100002,
                  left: focusBox.left + focusBox.width - 4,
                  top: focusBox.top + focusBox.height / 2 - 4,
